...
const ResultsButtonAgain = (props: any) => {
	...
	return <div className={styles.results_buttons}>
		<Link className={styles.results_button} to={props.url}>
			<h1 className={styles.results_text}>PLAY AGAIN</h1>
		</Link>
...
const ResultsMessage = (props: any) => {
	...
	if (victory == "true") {
		return <div>
			<Confetties className={styles.results_confetties} colors={["#48DAC3", "#60B5E7", "#BB86FC", "#FF6667", "#A4EDE1", "#B0DAF3", "#DDC3FE", "#FFB3B3"]}/>
			<h1 className={styles.results_h1}>VICTORY !</h1>
		</div>
	}
	return <div>
		<h1 className={styles.results_h1}>DEFEAT !</h1>
	</div>
}
